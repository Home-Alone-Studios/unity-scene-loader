<!---
# <img src="./Documentation/PackageManifestConfigIcon.png" alt="" width="35" height="35"/> 

# Contributing
Thanks for considering contributing to Scene Loader. Please read the guidelines below before you submit an issue or create a PR. 
...
| ----------- | -------- | ------- |
| Namespaces | PascalCase | `Papae.Tools.SceneManagement` |
...
## Pull requests
Pull requests should be made to the [develop branch](https://github.com/home-alone-studios/scene-loader/tree/develop).
--->